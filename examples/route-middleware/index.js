...
// Dummy users
var users = [
    { id: 0, name: 'tj', email: 'tj@vision-media.ca', role: 'member', website: 'http://bing.com' }
  , { id: 1, name: 'ciaran', email: 'ciaranj@gmail.com', role: 'member' ,  website: 'http://google.com' }
  , { id: 2, name: 'aaron', email: 'aaron.heckmann+github@gmail.com', role: 'admin' ,  website: 'http://linnovate.net' }
];
